...
-- Role(역할)을 통해 접속 및 테이블생성 등의 권한을 부여
...
형식] alter table 테이블명 drop column 삭제할 컬럼;
*/
-- mileage 컬럼을 삭제하시오.
...
insert into tb_member values (1, 'kosmo1', '1234', '코스모155기', 'kosmo155@naver.com');
insert into tb_member values (2, 'kosmo2', '1234', '코스모156기', 'kosmo155@gmail.com');
insert into tb_member values (3, 'kosmo3', '1234', '코스모157기', 'kosmo155@nate.com');
-- 삽입된 레코드 확인하기
SELECT * FROM tb_member;
-- 명시적 true 조건이므로 모든 레코드를 대상으로 인출한다.
SELECT * FROM tb_member where 1=1;
-- 명시적 false 조건이므로 레코드를 인출하지 않는다.
